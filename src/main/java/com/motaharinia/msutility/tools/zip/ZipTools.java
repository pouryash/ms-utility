package com.motaharinia.msutility.tools.zip;
...
public interface ZipTools {
     ...
     */
    static void unzipFromByteArray(byte[] sourceByteArray, @NotNull String destinationDirectoryForUnzip, String password) throws IOException {
     ...
     */
    static void unzip(@NotNull String sourceZipFilePath, @NotNull String destinationDirectoryForUnzip, String password) throws ZipException {
